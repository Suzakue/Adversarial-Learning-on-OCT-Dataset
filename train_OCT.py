...
from dataset.OCT_dataset import VOCDataSet, VOCGTDataSet

'''

CUDA_VISIBLE_DEVICES=2 python train_OCT.py --partial-data 0.125 --num-steps 20000 --lambda-adv-pred 0.01 \
...
DATA_LIST_PATH = '/home/hejiawen/pytorch/ZRRP/AI-OCT/data/cutted_data_path/train_images.txt'
LABEL_LIST_PATH = '/home/hejiawen/pytorch/ZRRP/AI-OCT/data/cutted_data_path/train_labels.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '256,256'      # 把512x512的图裁剪为4份----------------------------------------
...
def adjust_learning_rate(optimizer, i_iter):
    lr = lr_poly(args.learning_rate, i_iter, args.num_steps, args.power)    # power = 0.9
...
def delete_models(epoch, loss):
    path = osp.join(args.snapshot_dir, 'VOC_epoch_{0}_seg_loss_{1}.pth'.format(epoch, loss))
    path_D = osp.join(args.snapshot_dir, 'VOC_epoch_{0}_seg_loss_{1}_D.pth'.format(epoch, loss))
